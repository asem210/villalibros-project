        ...
        <div className="app-container-categories">
            ...
            <div className="wrapper-categories">
                <Tooltip
                    ...
                    placement="topRight"
                    trigger={["hover"]}
                    overlay={<span>Click para ver mangas</span>}
                >
                    <div className="wrapper-card">
                        <div
                            className="category-card"
                            onClick={() => navigate("/categoryCard")}
                        >
                            <img
                ...
                <Tooltip
                    ...
                    placement="topRight"
                    trigger={["hover"]}
                    overlay={<span>Click para ver libros en inglés</span>}
                >
                    <div className="wrapper-card">
                        <div
                            className="category-card"
                ...
                <Tooltip
                    ...
                    placement="topRight"
                    trigger={["hover"]}
                    overlay={<span>Click para ver libros Netflix</span>}
                >
                    <div className="wrapper-card">
                        <div
                            className="category-card"
                ...
                <Tooltip
                    ...
                    placement="topRight"
                    trigger={["hover"]}
                    overlay={<span>Click para ver libros sobre Wattpad</span>}
                >
                    <div className="wrapper-card">
                        <div
                            className="category-card"
                ...
                <Tooltip
                    ...
                    placement="topRight"
                    trigger={["hover"]}
                    overlay={<span>Click para ver libros sobre Tarot</span>}
                >
                    <div className="wrapper-card">
                        <div
                            className="category-card"
                ...
                <Tooltip
                    ...
                    trigger={["hover"]}
                    overlay={
                        <span>Click para ver libros sobre Pasatiempos</span>
                    }
                >
                    <div className="wrapper-card">
                        <div
